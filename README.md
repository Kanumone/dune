...
Mobile-first веб-приложение для поиска интересных мест с интерактивной картой.

## Особенности

- 📱 Mobile-first дизайн (9:16 aspect ratio)
- 🗺️ Интерактивная карта на основе Яндекс.Карт
- 🌙 Тёмная тема с тёплыми песочными акцентами
- ✨ Современная типографика и micro-interactions
- 🎯 Bottom sheet с информацией о местах
- 📍 Кластеры маркеров и индивидуальные пины
